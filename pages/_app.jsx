...
const GithubSvg = () => <svg width="24" height="24" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function MyApp({ Component, pageProps }) {
  return <Fragment>
    ...
    <footer>
        <a className="plain" title="Updates on Twitter" href="https://twitter.com/aaorris"><Icon graphic={TwitterSvg} /></a>
        <a className="plain" title="Code on Github" href="https://github.com/aaorris"><Icon graphic={GithubSvg} /></a>
        <a className="plain" title="Part of a Web Ring" href="https://webring.xxiivv.com "><Icon graphic={WebringSvg} /></a>
    </footer>
    <style jsx>{`
      nav {
        display: flex;
