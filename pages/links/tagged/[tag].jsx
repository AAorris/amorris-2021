...
function Links({ tag, items }) {
  ...
  <div style={{padding: 80, marginBottom: 30, background: 'white', textAlign: 'center'}}>
  <h1 style={{color: 'black', textTransform: 'capitalize'}}>Links Tagged {tag.name}</h1>
  ...
  {items.map(post => (
    ...
    <span className="leaves-space-for-tags">🔗 <a href={post.arg}>
